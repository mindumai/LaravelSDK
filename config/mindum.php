...
return [
    ...
    | API. Create an account at https://mindum.dev to obtain an API key.
    |
    */

    'api_key' => env('MINDUM_API_KEY'),

    'api_url' => env('MINDUM_API_URL', 'https://mindum.dev'),
    ...
    */
    ...
    'widget' => [
        ...
        'bundle_url' => env('MINDUM_WIDGET_BUNDLE_URL', 'https://mindum.dev/widget/v1/widget.js'),
        ...
        'ws_url' => env('MINDUM_WS_URL', 'wss://mindum.dev'),
